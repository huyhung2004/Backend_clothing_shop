...
using Backend_Clothing_Shop.Models;
using Microsoft.EntityFrameworkCore;

namespace Backend_Clothing_Shop.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__brands__3213E83F06E2D16B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__categori__3213E83F0C2F14C8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__orders__3213E83F5E085386");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__order_de__3213E83FA6B80DA0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__products__3213E83F883AC259");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__product___3213E83FC34533D0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__product___3213E83F363447BC");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__60883D90BE69E754");
        ...
        {
            entity.HasKey(e => e.MediaId).HasName("PK__ReviewMe__D0A840F4412C9532");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__roles__3213E83FAE0C9DBF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Shipping__3213E83FC563C731");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__social_a__3213E83F64812BAC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tokens__3213E83F0EF8A5A4");

            entity.ToTable("tokens");

            entity.HasIndex(e => e.Token1, "UQ__tokens__CA90DA7ABCA2D23D").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__users__3213E83F50BD1044");
